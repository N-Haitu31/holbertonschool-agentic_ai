  ...
  <footer class="bg-slate-950 border-t border-slate-800">
    <div class="max-w-6xl mx-auto px-6 py-16">
      <div class="flex flex-col md:flex-row justify-between gap-12">
        <div class="gap-4">
          <Brand class="mb-4" />
          <p class="text-xs text-slate-500 mb-4">Explore the future of development with Agentic AI.</p>
        ...
        <div class="grid grid-cols-3 gap-8 mb-8">
          <div>
            <h3 class="text-slate-50 mb-4 text-sm font-bold">Navigation</h3>
            <ul class="text-xs text-slate-500 flex flex-col justify-start items-start gap-2">
          ...
          <div>
            <h3 class="text-slate-50 mb-4 text-sm font-bold">Holberton School</h3>
            <ul class="text-xs text-slate-500 flex flex-col justify-start items-start gap-2">
          ...
          <div>
            <h3 class="text-slate-50 mb-4 text-sm font-bold">Curriculum</h3>
            <ul class="text-xs text-slate-500 flex flex-col justify-start items-start gap-2">
      ...
      <hr />
      <div class="max-w-6xl mx-auto pt-6 pb-24 flex flex-col md:flex-row justify-center md:justify-between items-start md:items-center text-xs text-slate-500 border-t border-slate-900">
