...
<template>
  <section id="hero-section" class="relative bg-slate-950 border-b border-slate-800 pt-36 pb-24">
    ...
    <div class="max-w-6xl mx-auto px-6 flex flex-col items-center text-center relative z-10">
      <SectionBadge text="The future of coding" />
      <h1 class="mb-8 text-5xl md:text-7xl font-black tracking-tight leading-none">
        <span class="block text-white">Build smarter workflows</span>
        <span class="block text-violet-300">with Agentic AI</span>
      </h1>
      <p class="mb-8 text-slate-300 max-w-2xl mt-6">
